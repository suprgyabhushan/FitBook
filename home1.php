    ...
    <div class="col-xs-12">
        <div class="page-header">
            <h1 class="text-center">
               <center> <img src="img/google-fit.png" title="Your Google Fit" alt="Google Fit icon" height="100" width="100">
                <img src="img/steps.png" title="collected steps" alt="Footsteps" height="100" width="100">
                <span title="in">&rarr;</span>
                <img src="img/fitbit.png" title="your Fitbit account" alt="Fitbit icon" height="100" width="100">
                <span title="equals">=</span>
                <img src="img/party.png" title="PARTAYYY" alt="Yolo" height="100" width="100"></center>
            </h1>
        </div>
    </div>
</div>
