    ...
    <div class="col-xs-12">
        <div class="page-header">
            <h1 class="text-center">
                <img src="google-fit.png" title="Your Google Fit" alt="Google Fit icon">
                <img src="steps.png" title="collected steps" alt="Footsteps">
                <span title="in">&rarr;</span>
                <img src="fitbit.png" title="your Fitbit account" alt="Fitbit icon">
                <span title="equals">=</span>
                <img src="party.png" title="PARTAYYY" alt="Yolo">
            </h1>
        </div>
    </div>
</div>
